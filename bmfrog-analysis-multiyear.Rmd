...
$$p_{k(s,i)} ∣ f_{k(s,i)} = 0 ∼ Beta(\alpha_{1,s}, \beta_{1,s}) $$
$$p_{k(s,i)} ∣ f_{k(s,i)} = 1 ∼ Beta(\alpha_{2,s}, \beta_{2,s}) $$
...
ggsave(plot = sp_r_plot, filename = "outputs/plots/sp_r_plot.pdf", width = 2400, height = 1600, units = "px")
