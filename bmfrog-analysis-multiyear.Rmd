...
```{r, fig.width = 18, fig.height = 30, eval = FALSE, include = FALSE, echo=FALSE}
...
```{r, fig.width = 10, fig.height = 6, eval = FALSE, include = FALSE, echo = FALSE}
...
ggsave(plot = cov_plot_joined, filename = "outputs/plots/occupancy_covariate_effects.png", width = 4000, height = 4250, units = "px")
